...
CREATE TABLE `monografia` (
  ...
  PRIMARY KEY (`cutter`),
  KEY `curso` (`curso`),
  CONSTRAINT `monografia_ibfk_1` FOREIGN KEY (`cutter`) REFERENCES `item` (`cutter`),
  CONSTRAINT `monografia_ibfk_2` FOREIGN KEY (`curso`) REFERENCES `curso` (`curso`)
...
LOCK TABLES `monografia` WRITE;
/*!40000 ALTER TABLE `monografia` DISABLE KEYS */;
/*!40000 ALTER TABLE `monografia` ENABLE KEYS */;
UNLOCK TABLES;
